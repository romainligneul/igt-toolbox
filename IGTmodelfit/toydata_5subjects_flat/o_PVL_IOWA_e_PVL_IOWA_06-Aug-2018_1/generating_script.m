...
switch A.fit.priors.type
    ...
    case 'secondpass'
        ...
        options.priors.first_pass = [A.main_path '/504s_vba_flat/o_PVL_IOWA_e_PVL_IOWA_13-Jun-2017_1/fitted_model.mat'];
    ...
    case 'informed2' % priors from second pass
        
        priors.muPhi = -2.19927253238905;
        priors.SigmaPhi = 0.515791560862672;
        priors.muTheta = [-0.855141016741986,-1.60879833622695,0.764787896726035];
        priors.SigmaTheta = [0.287882209376611,0,0;0,2.18800667452825,0;0,0,1.84078329121181];
        priors.muX0(1:4,1) = [0 0 0 0];
...
% inF = evolution
options.inF.param_name = {'shape', 'loss aversion', 'recency'};
